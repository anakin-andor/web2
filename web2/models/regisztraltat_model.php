...
class Regisztraltat_Model
{
	public function get_data($vars)
	{
		...
		try {
            ...
            $sqlInsert = "insert into felhasznalok(id, csaladinev, utonev, bejelentkezes, jelszo, jogosultsag)
                              values(0, :csaladinev, :utonev, :bejelentkezes, :jelszo, jogosultsag)";
                
            $stmt = $connection->query($sqlInsert);
